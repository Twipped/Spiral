...
export const MB_MOODS = [
  { name: 'Anger', color: '#E23838', emotions: [

  ] },
  { name: 'Anxiety', color: '#F78200', emotions: [

  ] },
  { name: 'Neutral', color: '#FFB900', factor: 1.3, emotions: [

  ] },
  { name: 'Joy', color: '#5EBD3E', emotions: [

  ] },
  { name: 'Sadness', color: '#009CDF', emotions: [

  ] },
];

export const MB_MOOD_STROKE_WIDTH_INACTIVE = 1;
export const MB_MOOD_STROKE_WIDTH_ACTIVE = 4;
export const MB_MOOD_STROKE_COLOR_INACTIVE = '#333';
export const MB_MOOD_STROKE_COLOR_ACTIVE = 'purple';
