...
// 	const dayState = await mockStorage.getItem('@CalendarStore:2018-07');
...
// 	await mockStorage.setItem('@CalendarStore:2018-07', { 5: { foo: 16, baz: 100 } });

// 	await CalendarStore.ensureMonth(2018, 7);
// 	const dayState = CalendarStore.getDay(2018, 7, 5);
